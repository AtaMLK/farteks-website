        ...
        <div className="mx-auto max-w-[1440px] px-5 md:px-10 lg:px-14">
          <div className="grid items-center gap-12 lg:grid-cols-[0.72fr_1.28fr] lg:gap-20">
            <div className="relative">
              ...
              <p className="text-sm font-semibold uppercase tracking-[0.24em] text-[#E5322D]">Inside Farteks</p>
              <h2 className="mt-5 max-w-xl text-[clamp(2.8rem,5vw,5.6rem)] font-extrabold leading-[0.92] tracking-[-0.055em]">
                Built around<br /><span className="text-white/35">precision.</span>
              </h2>
              ...
              <div className="mt-9 flex items-center gap-6">
                <div><p className="text-[10px] font-bold uppercase tracking-[0.24em] text-white/35">Company film</p><p className="mt-1 text-sm font-semibold text-white/80">04:30</p></div>
                <span className="h-8 w-px bg-white/10" />
                <Link href="/about" className="group inline-flex items-center gap-2 text-sm font-semibold text-white/75 transition hover:text-white">
                  More about Farteks
