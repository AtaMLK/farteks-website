...
export default function IndustriesPage() {
  return (
    <main className="">
      <PageIntro eyebrow="Farteks / industries" title="Industries We Serve" description="FARTEKS hydraulic components are trusted across diverse industries worldwide. From construction to marine applications, our solutions deliver reliability and performance." />
