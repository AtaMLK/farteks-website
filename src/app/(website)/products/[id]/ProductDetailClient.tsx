  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-slate-50">
      <Container>
        ...
        <div className="flex flex-col gap-8 py-8 sm:py-12 lg:grid lg:grid-cols-2 lg:gap-8 lg:py-16">
          <div className="min-w-0">
            <div className="relative aspect-square w-full overflow-hidden rounded-[20px] border border-slate-200 bg-white">
              <Image
                key={currentImage}
                src={currentImage}
                alt={currentImageAlt}
