...
export default function ProductGroupsPage() {
  return (
    <div className="min-h-screen bg-white pb-12">
      <PageIntro eyebrow="Farteks / products" title="Product Categories" description="Browse our comprehensive range of hydraulic cylinder components organized by type." />
