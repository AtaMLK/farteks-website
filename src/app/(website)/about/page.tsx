          ...
          <FadeIn>
            <div className="max-w-3xl">
              ...
              <p className="mt-8 text-xl leading-8 text-slate-600">
                Since 1980, FARTEKS has been manufacturing precision hydraulic
                cylinder components for leading OEM partners worldwide. Our
                commitment to quality, innovation, and customer service has made
                us a trusted partner in the hydraulic industry.
              </p>
            </div>
          </FadeIn>
        </Container>
