            ...
            <div style="max-width:680px;margin:40px auto;background:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #e5e7eb;">
              <div style="background:#392B87;padding:28px 32px;color:white;">
                ...
                <h1 style="margin:10px 0 0;font-size:28px;">
                  ${requestType === "quote" ? "New Quote Request" : "New Contact Message"}
                </h1>
              </div>
              ...
              <div style="padding:32px;">
                <table style="width:100%;border-collapse:collapse;">
                  <tr>
                    ...
                    <td style="padding:10px 0;">${escapeHtml(normalizedName)}</td>
                  </tr>
                  <tr>
                  ...
                  ${
                    normalizedPhone
                      ? `<tr><td style="padding:10px 0;font-weight:bold;">Phone</td><td style="padding:10px 0;">${escapeHtml(normalizedPhone)}</td></tr>`
                      : ""
                  }
                  ${
                    normalizedSubject
                      ? `<tr><td style="padding:10px 0;font-weight:bold;">Subject</td><td style="padding:10px 0;">${escapeHtml(normalizedSubject)}</td></tr>`
                      : ""
                  }
                  <tr>
                    <td style="padding:10px 0;font-weight:bold;">Request Type</td>
                    <td style="padding:10px 0;">${requestType === "quote" ? "Request Quote" : "Message"}</td>
                  </tr>
                </table>
