...
export default function ProductDetailPage() {
  ...
  if (!product) {
    return (
      <div className="min-h-screen mt-5 flex items-center justify-center bg-slate-50">
        ...
        <div className="pb-12 border-b border-slate-200">
          <div className="flex items-start justify-between mb-4">
            <div>
              ...
              <p className="text-lg text-slate-600">{product.groupName}</p>
            </div>
          ...
          <div>
            <div className="relative bg-white rounded-[20px] border border-slate-200 h-96 mb-4 flex items-center justify-center overflow-hidden">
              <Image
                ...
                alt={
                  imageTab === "product" ? product.name : "Technical Drawing"
                }
                fill
          ...
          <div className="bg-white rounded-[20px] border border-slate-200 p-8 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="border-b border-slate-200 pb-4">
                ...
                <p className="text-slate-900">{product.groupName}</p>
              </div>
