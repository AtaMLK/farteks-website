      ...
      <Container className="grid gap-16 py-20 md:grid-cols-4">
        ...
        <div>
          ...
          <div className="space-y-4 flex flex-col">
            ...
            <Link href="/gallery" className="hover:text-[#E5322D] transition-colors">Gallery</Link>
        ...
        <div>
          ...
          <div className="space-y-4 flex flex-col">
            <Link href="/products/gland-cast-iron-din1691" className="hover:text-[#E5322D] transition-colors">Glands</Link>

            <Link href="/products/group/rod-end" className="hover:text-[#E5322D] transition-colors">Rod Ends</Link>

            <Link href="/products/piston" className="hover:text-[#E5322D] transition-colors">Pistons</Link>

            <Link href="/products/group/custom-hydraulic" className="hover:text-[#E5322D] transition-colors">Custom Parts</Link>
          </div>
        </div>
