...
export function ProductCard({
  ...
  const handleTouch = (e: React.TouchEvent) => {
    // First tap reveals the information.
    // Navigation happens through the Details button.
    if (!revealed) {
      e.preventDefault();
      setRevealed(true);
    }
        ...
        >
          ...
          >
            ...
            <Link
              href={href}
              onClick={(e) => {
                // On mobile the first tap only reveals the card.
                // Details is always the actual navigation action.
                e.stopPropagation();
              }}
              className="
                inline-flex
