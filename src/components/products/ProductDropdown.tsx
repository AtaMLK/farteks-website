    ...
    >
      <div className="mx-auto w-full max-w-7xl px-6 py-8">
        <div className="grid min-w-0 grid-cols-6 gap-6">
          {PRODUCT_GROUPS.map((group) => {
            ...
            return (
              <div
                key={group.id}
                className={isCustom ? "group/item min-w-0 lg:col-span-6" : "group/item min-w-0"}
              >
                <Link
                  href={href}
                  className={`mb-4 flex min-w-0 items-center gap-2 border-b-2 border-slate-100 pb-2 transition-colors group-hover/item:border-orange-500 ${isCustom ? "rounded-xl border border-orange-200 bg-linear-to-r from-orange-50 via-white to-red-50 px-4 py-3 shadow-sm" : ""}`}
                >
                  ...
                  <ChevronRight
                    size={18}
                    className="shrink-0 text-slate-400 transition-colors group-hover/item:text-orange-500"
                  />
                </Link>
                  ...
                  <div className="space-y-2">
                    ...
                    {groupProducts.length > 5 && (
                      <Link
                        ...
                        className="block text-xs font-semibold text-orange-500 transition-colors hover:text-orange-600"
                      >
        ...
        <div className="mt-8 flex items-center justify-between border-t border-slate-200 pt-8">
          <div className="rounded-3xl border border-orange-200 bg-linear-to-br from-orange-50 to-red-50 px-5 py-4">
            ...
            <div className="space-y-2">
              <Link
                href="/products"
                className="block text-xs font-semibold text-slate-600 transition-colors hover:text-orange-500"
              >
                → All Products
              </Link>
