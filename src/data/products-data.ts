...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    id: "steel-gland",
    productCode: "GDC-CB-",
    availableMaterials: ["CK45 / C45", "S355", "11SMn30", "11SMnPb30"],
    name: "Steel Gland",
    category: "STD.1",
  ...
  },
  {
    ...
    category: "TRU",
    description:
      "Trunnions for hydraulic cylinder applications, manufactured to dimensional and application requirements.",
    groupName: "Trunnion",
    image: "/images/products/custom.png",
    singleImage: "/images/products/custom-single.png",
    drawingImage: "/images/drawings/customproductdrawing.png",
    availableMaterials: ["CK45 / C45", "S355", "11SMn30", "11SMnPb30"],
    specColumns: ["Design", "Material", "Production"],
    specs: [
      {
        Design: "Application-specific dimensions",
        Material: "Selected to customer requirements",
        Production: "CNC machined",
      },
    ],
  },
  {
...
export const getProductsByCategory = (
  category: "STD.1" | "STD.2" | "MC" | "RE" | "ISO" | "UNI" | "CUSTOM",
): Product[] => {
