...
export const hero = {
  ...
  image: "/images/ui-images/hero-machine.webp",
};
...
export const trustItems = [
  { title: "Precision Manufacturing", icon: Cog },
  { title: "OEM Production", icon: Factory },
  { title: "Worldwide Export", icon: Globe2 },
  { title: "Quality Control", icon: ShieldCheck },
  { title: "Custom Machining", icon: Settings },
  { title: "Fast Logistics", icon: Truck },
];
